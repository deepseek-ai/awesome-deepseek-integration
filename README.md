  ...
  <td>
   ...
   <tr>
    ...
    <tr>
        ...
        <td>Tokeny is a locally-run AI Agent desktop application — beyond chat, it actually executes operations: invoking tools, reading/writing files, running commands, and performing multi-step planning and decision-making. See <a href="https://www.tokeny-ai.com/docs">documentation</a>.</td>
    </tr>
</table>
