...
<table>
    ...
    <tr>
        ...
        <td> ChatPDFLocal is an AI powered Mac OS App for helping to chat local PDF 100% securely, it works seamlessly with DeepSeek and other multiple AI models to improve your reading efficiency. </td>
    </tr>
