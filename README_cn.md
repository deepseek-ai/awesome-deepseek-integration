...
<table>
    ...
    <tr>
        ...
        <td><a href="docs/Worldloom/README_cn.md">织界 WorldLoom</a></td>
        <td><a href="https://worldloom.top/">织界 WorldLoom</a> 是一款 AI 驱动的多世界文字冒险 RPG，支持接入 DeepSeek 等大模型进行开局生成、剧情推进、行动选项生成、角色状态更新、NPC 记忆与动态局势呈现。玩家可以在不同世界观中创建角色，并在持续变化的时间线中展开自由叙事。</td>
    </tr>
    <tr>
