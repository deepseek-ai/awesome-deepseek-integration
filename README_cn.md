...
<table>
    ...
    <tr>
        ...
        <td>MateClaw 是一个开源的个人 AI 操作系统，基于 Spring Boot + Spring AI Alibaba 构建，内置 DeepSeek V4 Pro 与 V4 Flash 模型支持。一个 JAR 让同一个 Agent 同时出现在 Web 控制台、桌面端、可嵌入网页插件、Java 插件 SDK 与 8 个 IM 渠道（钉钉、飞书、企业微信、微信、Telegram、Discord、QQ、Slack）；附带多供应商故障转移、ReAct + Plan-and-Execute Agent 编排、带引用的 LLM Wiki、记忆生命周期、MCP 与 Tool Guard。</td>
    </tr>
</table>
