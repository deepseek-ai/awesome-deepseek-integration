...
<table>
    ...
    <tr>
        <td> <img src="docs/shunshi-ai/assets/logo.png" alt="图标" width="64" height="auto" style="border-radius: 15px" /> </td>
        <td> <a href="https://github.com/deepseek-ai/awesome-deepseek-integration/blob/main/docs/shunshi-ai/README_cn.md">顺时 AI (Shunshi.AI)</a> </td>
        <td> 基于 DeepSeek API 的对话式命理助手：以八字排盘（四柱 / 四柱推命 / 사주팔자）为根基，结合真太阳时修正得到准确命盘后，由大模型围绕这张盘回答人生规划、事业、感情等问题。支持中文 / English / 日本語 / 한국어 多语言。 </td>
    </tr>
</table>
