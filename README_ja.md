...
<table>
    ...
    <tr>
        ...
        <td><a href="docs/AhaKnowChat/README_ja.md">AhaKnow Chat</a></td>
        <td>OpenAI-compatible API 経由で DeepSeek を利用できるローカルファーストの AI チャットワークスペース。トピックベースのスレッド、再利用可能なロール、マルチロールのブレインストーミング、ブラウザローカル保存を備え、Web 版は Vercel に静的デプロイできます。</td>
    </tr>
    <tr>
