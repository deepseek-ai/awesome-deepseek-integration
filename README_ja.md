...
<table>
    ...
    <tr>
        <td> <img src="http://p0.qhimg.com/t11098f6bcdf61c778dce3a329e.png" alt="Icon" width="64" height="auto" /> </td>
        <td> <a href="https://www.fangcloud.com">360亿方云</a> </td>
        <td> 企業向けのクラウド型ファイル管理・コラボレーションプラットフォームです。大容量ストレージ、チームでのファイル共有とコラボレーション、セキュリティと権限管理、AIによる知識Q&A、インテリジェントな知識アシスタントなどの機能を提供し、企業の知識を集約し、生産性向上を支援します。</td>
    </tr>
</table>
